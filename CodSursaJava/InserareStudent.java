...
public class InserareStudent {
	...
	InserareStudent(int x, int y, String nume, String prenume, Connection c) {
		con = c;
		this.x = x;
		this.y = y;
		this.nume = nume;
		this.prenume = prenume;
		frame = new JFrame("Inserare Student");
		...
		JLabel s = new JLabel("Inserare Student");
        ...
        JLabel nume1=new JLabel("An Studiu");
        tf2.setColumns(10);
        panel3.add(nume1);
        panel3.add(tf2);
        panel3.setLayout(new FlowLayout());
        
        JLabel prenume1=new JLabel("NR ore");
        tf3.setColumns(10);
        panel4.add(prenume1);
        panel4.add(tf3);
		...
		ok.addActionListener(new InsStud());
		panel5.add(ok);
	...
	class InsStud implements ActionListener {

		@Override
		public void actionPerformed(ActionEvent e) {
			try {
				CallableStatement mySt = null;
				mySt = con.prepareCall("{call insert_student(?, ?, ?)}");
